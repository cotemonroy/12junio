...
<?php if((basename($_SERVER['PHP_SELF']))=='biblio.php'){?>
<header class="intro-header" style="background-image: url('img/color.jpg')">
<?php };?>

<?php if((basename($_SERVER['PHP_SELF']))=='viz.php'){?>
<header class="intro-header" style="background-image: url('img/hola.jpg')">
<?php };?>

<?php if((basename($_SERVER['PHP_SELF']))=='refs.php'){?>
<header class="intro-header" style="background-image: url('img/chao.jpg')">
<?php };?>
